  ...
  return (
    <div className="animate-fade-in pb-20 w-full">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        {/* INFO STATUS */}
        <div className="bg-brand-primary/10 border border-brand-primary/20 rounded-[32px] p-8 flex flex-col md:flex-row items-start gap-6 h-full">
            <div className="bg-brand-primary p-4 rounded-2xl shadow-lg shadow-brand-primary/40 shrink-0">
        ...
        {/* BACKUPS */}
        <div className="bg-[#0f172a] border border-white/5 rounded-[32px] p-8 shadow-2xl h-full flex flex-col justify-between">
            <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-auto">
                <button onClick={exportData} className="flex-1 px-6 py-4 bg-slate-800 text-white rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-slate-700 transition-colors">
                    <DownloadCloud size={18} /> Exportar Biblioteca
                </button>
                <button onClick={() => fileInputRef.current?.click()} className="flex-1 px-6 py-4 bg-slate-800 text-white rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-slate-700 transition-colors">
                    <UploadCloud size={18} /> Importar Biblioteca
                </button>
