...
import { Database, DownloadCloud, UploadCloud, Sparkles, ShieldCheck, Zap } from 'lucide-react';
...
export const Settings: React.FC = () => {
  ...
  return (
    <div className="animate-fade-in pb-20 max-w-4xl mx-auto px-4">
      ...
      <p className="text-slate-400 mb-10">Nexus ahora utiliza Inteligencia Artificial para el descubrimiento de datos.</p>
      ...
      <div className="space-y-8">
        ...
        <div className="bg-brand-primary/10 border border-brand-primary/20 rounded-[32px] p-8 flex items-start gap-6">
            ...
            <div>
                <h2 className="text-xl font-bold text-white mb-2">Nexus Engine v3: Online</h2>
                <p className="text-sm text-slate-400 leading-relaxed">
                    Hemos desactivado el sistema de proxies e IGDB por su inestabilidad. 
                    Ahora las búsquedas son procesadas por <b>Gemini 3 Flash</b>, garantizando 
                    resultados rápidos, descripciones ricas y carátulas de alta resolución sin bloqueos.
                </p>
        ...
        <div className="bg-[#0f172a] border border-white/5 rounded-[32px] p-8 shadow-2xl">
            ...
            <p className="text-sm text-slate-400 mb-6">Toda tu biblioteca se guarda de forma local en este navegador.</p>
